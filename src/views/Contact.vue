      ...
      <div class="wrapper">
        ...
        <div class="company-info">
          ...
          <ul>
            ...
            <li><i class="fa fa-envelope"></i> jdmprecision69@gmail.com</li>
          </ul>
          <img
            class="pt-5"
            src="https://i.postimg.cc/fRssH01j/jdm.png"
            alt="Logo"
...
.company-info {
  background-image: linear-gradient(to right, blueviolet, rgb(46, 0, 83));
